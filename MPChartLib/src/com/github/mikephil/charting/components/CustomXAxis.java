 ...
 */
public class CustomXAxis extends AxisBase {

    /** the arraylist containing all the x-axis labels */
    protected List<Bitmap> mValues = new ArrayList<Bitmap>();
    ...
    private CustomXAxisPosition mPosition = CustomXAxisPosition.TOP;

    /** enum for the position of the x-labels relative to the chart */
    public enum CustomXAxisPosition {
     ...
     */
    public CustomXAxisPosition getPosition() {
        return mPosition;
    }
     ...
     * @param pos
     */
    public void setPosition(CustomXAxisPosition pos) {
        mPosition = pos;
    }
     ...
     * @param values
     */
    public void setValues(List<Bitmap> values) {
        mValues = values;
    }
