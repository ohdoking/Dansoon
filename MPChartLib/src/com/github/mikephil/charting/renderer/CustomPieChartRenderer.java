...
public class CustomPieChartRenderer extends CustomDataRenderer {

    protected CustomPieChart mChart;
    ...
    public CustomPieChartRenderer(CustomPieChart chart, ChartAnimator animator,
    ...
    public void drawData(Canvas c) {
        ...
        CustomPieData pieData = mChart.getData();
    ...
    public void drawValues(Canvas c) {
        ...
        CustomPieData data = mChart.getData();
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            ...
            for (int j = 0, maxEntry = Math.min(
                ...
                //ohdoking change here
                float x2 = (float) (r*1.7
                        * Math.cos(Math.toRadians(rotationAngle + angle))
                        + center.x);
                float y2 = (float) (r*1.7
                        * Math.sin(Math.toRadians(rotationAngle + angle))
                        + center.y);
                ...
                if (drawXVals && drawYVals) {
                    ...
                    paint.setColor(dataSet.getColor(j));                          // 라인 색깔
                    paint.setStrokeWidth(3);
                    c.drawLine(x, y, (float)x2, y2 + lineHeight - 60, paint);
                    ...
                    if (j < data.getXValCount()) {
                        ...
                        c.drawBitmap(data.getXVals().get(j), (float)(x/1.2), y + lineHeight / 2f, mValuePaint);
                    }
                } else if (drawYVals) {
