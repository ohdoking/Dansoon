...
public class CustomXAxisRendererBarChart extends CustomXAxisRenderer {

    protected CustomBarChart mChart;

    public CustomXAxisRendererBarChart(ViewPortHandler viewPortHandler, CustomXAxis xAxis, Transformer trans,
