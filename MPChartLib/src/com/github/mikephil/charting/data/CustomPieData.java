 ...
 */
public class CustomPieData extends CustomChartData<IPieDataSet> {

    public CustomPieData() {
        super();
    }

    public CustomPieData(List<Bitmap> xVals) {
        super(xVals);
    }

    public CustomPieData(Bitmap[] xVals) {
        super(xVals);
    }

    public CustomPieData(List<Bitmap> xVals, IPieDataSet dataSet) {
        super(xVals, toList(dataSet));
    }

    public CustomPieData(Bitmap[] xVals, IPieDataSet dataSet) {
        super(xVals, toList(dataSet));
    }
