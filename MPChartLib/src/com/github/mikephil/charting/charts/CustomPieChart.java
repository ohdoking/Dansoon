...
import com.github.mikephil.charting.renderer.CustomPieChartRenderer;
 ...
 */
public class CustomPieChart extends CustomPieRadarChartBase<CustomPieData> {
...
//        mLegendRenderer.renderLegend(canvas);
    ...
    public void calculateOffsets() {
        ...
        //ohdoking change in here
        //piechart circle size
        mCircleBox.set(c.x - radius/1.5f + shift,
                c.y - radius/1.5f + shift,
                c.x + radius/1.5f - shift,
                c.y + radius/1.5f - shift);
...
//        mCircleBox.set)
    ...
    public void setHoleColor(int color) {
        ((CustomPieChartRenderer) mRenderer).getPaintHole().setColor(color);
    }
    ...
    public void setCenterTextTypeface(Typeface t) {
        ((CustomPieChartRenderer) mRenderer).getPaintCenterText().setTypeface(t);
    }
    ...
    public void setCenterTextSize(float sizeDp) {
        ((CustomPieChartRenderer) mRenderer).getPaintCenterText().setTextSize(
    ...
    public void setCenterTextSizePixels(float sizePixels) {
        ((CustomPieChartRenderer) mRenderer).getPaintCenterText().setTextSize(sizePixels);
    }
    ...
    public void setCenterTextColor(int color) {
        ((CustomPieChartRenderer) mRenderer).getPaintCenterText().setColor(color);
    }
    ...
    public void setTransparentCircleColor(int color) {
        ...
        Paint p = ((CustomPieChartRenderer) mRenderer).getPaintTransparentCircle();
    ...
    public void setTransparentCircleAlpha(int alpha) {
        ((CustomPieChartRenderer) mRenderer).getPaintTransparentCircle().setAlpha(alpha);
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mRenderer != null && mRenderer instanceof CustomPieChartRenderer) {
            ((CustomPieChartRenderer) mRenderer).releaseBitmap();
        }
