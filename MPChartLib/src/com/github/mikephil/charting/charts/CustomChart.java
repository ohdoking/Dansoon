...
import com.github.mikephil.charting.data.CustomChartData;
import com.github.mikephil.charting.data.Entry;
import com.github.mikephil.charting.formatter.DefaultValueFormatter;
import com.github.mikephil.charting.formatter.ValueFormatter;
import com.github.mikephil.charting.highlight.ChartHighlighter;
import com.github.mikephil.charting.highlight.Highlight;
import com.github.mikephil.charting.interfaces.dataprovider.CustomChartInterface;
 ...
 */
@SuppressLint("NewApi")
public abstract class CustomChart<T extends CustomChartData<? extends IDataSet<? extends Entry>>> extends
        ViewGroup
        implements CustomChartInterface {
    ...
    private String mNoDataText = "이번달 등록된 다이어리가 없습니다.";
     ...
     */
    public CustomChart(Context context, AttributeSet attrs, int defStyle) {
     ...
     * @return
     */
    public Bitmap getXValue(int index) {
     ...
     * @return
     */
    public CustomDataRenderer getRenderer() {
        return mRenderer;
    }
     ...
     * @param renderer
     */
    public void setRenderer(CustomDataRenderer renderer) {
