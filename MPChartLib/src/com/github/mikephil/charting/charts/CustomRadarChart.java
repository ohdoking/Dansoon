...
import com.github.mikephil.charting.data.CustomRadarData;
import com.github.mikephil.charting.data.Entry;
import com.github.mikephil.charting.highlight.Highlight;
import com.github.mikephil.charting.renderer.CustomRadarChartRenderer;
import com.github.mikephil.charting.renderer.CustomXAxisRendererRadarChart;
import com.github.mikephil.charting.renderer.CustomYAxisRendererRadarChart;
 ...
 */
public class CustomRadarChart extends CustomPieRadarChartBase<CustomRadarData> {
     ...
     */
    private CustomXAxis mXAxis;

    protected CustomYAxisRendererRadarChart mYAxisRenderer;
    protected CustomXAxisRendererRadarChart mXAxisRenderer;

    public CustomRadarChart(Context context) {
        super(context);
    }

    public CustomRadarChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomRadarChart(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mRenderer = new CustomRadarChartRenderer(this, mAnimator, mViewPortHandler);
        mYAxisRenderer = new CustomYAxisRendererRadarChart(mViewPortHandler, mYAxis, this);
        mXAxisRenderer = new CustomXAxisRendererRadarChart(mViewPortHandler, mXAxis, this);
    }
