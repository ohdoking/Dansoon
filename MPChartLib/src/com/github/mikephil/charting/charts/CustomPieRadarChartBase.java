 ...
 */
public abstract class CustomPieRadarChartBase<T extends CustomChartData<? extends IDataSet<? extends Entry>>>
        extends CustomChart<T> {
    ...
    public CustomPieRadarChartBase(Context context) {
        super(context);
    }

    public CustomPieRadarChartBase(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomPieRadarChartBase(Context context, AttributeSet attrs, int defStyle) {
...
//            mLegendRenderer.computeLegend(mData);
    ...
    public void calculateOffsets() {
        ...
        if (this instanceof CustomRadarChart) {
            CustomXAxis x = ((CustomRadarChart) this).getXAxis();
