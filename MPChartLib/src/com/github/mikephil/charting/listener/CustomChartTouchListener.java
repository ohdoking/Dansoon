...
import com.github.mikephil.charting.charts.CustomChart;
...
public abstract class CustomChartTouchListener<T extends CustomChart<?>> extends GestureDetector.SimpleOnGestureListener implements View.OnTouchListener {
...
/**
    ...
    public CustomChartTouchListener(T chart) {
        this.mChart = chart;
