 ...
 */
public class CustomBarData extends CustomBarLineScatterCandleBubbleData<IBarDataSet> {
    ...
    public CustomBarData(List<Bitmap> xVals) {
        super(xVals);
    }

    public CustomBarData(Bitmap[] xVals) {
        super(xVals);
    }

    public CustomBarData(List<Bitmap> xVals, List<IBarDataSet> dataSets) {
        super(xVals, dataSets);
    }

    public CustomBarData(Bitmap[] xVals, List<IBarDataSet> dataSets) {
        super(xVals, dataSets);
    }

    public CustomBarData(List<Bitmap> xVals, IBarDataSet dataSet) {
        super(xVals, toList(dataSet));
    }

    public CustomBarData(Bitmap[] xVals, IBarDataSet dataSet) {
        super(xVals, toList(dataSet));
    }
