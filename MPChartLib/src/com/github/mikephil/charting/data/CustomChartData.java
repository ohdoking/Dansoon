 ...
 */
public abstract class CustomChartData<T extends IDataSet<? extends Entry>> {
     ...
     * @param xVals
     */
    public CustomChartData(List<Bitmap> xVals) {
        this.mXVals = xVals;
     ...
     * @param xVals
     */
    public CustomChartData(Bitmap[] xVals) {
     ...
     */
    public CustomChartData(List<Bitmap> xVals, List<T> sets) {
        this.mXVals = xVals;
        this.mDataSets = sets;
     ...
     * @param sets  the dataset array
     */
    public CustomChartData(Bitmap[] xVals, List<T> sets) {
        this.mXVals = arrayToList(xVals);
        this.mDataSets = sets;
     ...
     * @return
     */
    private List<Bitmap> arrayToList(Bitmap[] array) {
     ...
     * @param xVal
     */
    public void addXValue(Bitmap xVal) {
