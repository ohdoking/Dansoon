...
public class CustomXAxisRendererHorizontalBarChart extends CustomXAxisRendererBarChart {

    public CustomXAxisRendererHorizontalBarChart(ViewPortHandler viewPortHandler, CustomXAxis xAxis,
                                                 Transformer trans, CustomBarChart chart) {
        super(viewPortHandler, xAxis, trans, chart);
    }
    
    @Override
    public void computeAxis(float xValAverageLength, List<Bitmap> xValues) {
    ...
    protected void drawLabels(Canvas c, float pos, PointF anchor) {
        ...
        CustomBarData bd = mChart.getData();
        ...
        for (int i = mMinX; i <= mMaxX; i += mXAxis.mAxisLabelModulus) {
            ...
            if (mViewPortHandler.isInBoundsY(position[1])) {
                ...
                drawLabelBitmap(c, label, i * i, pos + 50, position[1], anchor, labelRotationAngleDegrees);
            }
        }
    }
