...
public abstract class CustomRenderer {
    ...
    public CustomRenderer(ViewPortHandler viewPortHandler) {
     ...
     * @param xAxisModulus
     */
    public void calcXBounds(CustomBarLineScatterCandleBubbleDataProvider dataProvider, int xAxisModulus) {
