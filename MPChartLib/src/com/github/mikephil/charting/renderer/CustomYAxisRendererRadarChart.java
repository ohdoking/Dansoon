...
public class CustomYAxisRendererRadarChart extends YAxisRenderer {

    private CustomRadarChart mChart;

    public CustomYAxisRendererRadarChart(ViewPortHandler viewPortHandler, YAxis yAxis, CustomRadarChart chart) {
