...
import com.github.mikephil.charting.interfaces.dataprovider.CustomBarLineScatterCandleBubbleDataProvider;
...
public abstract class CustomBarLineChartBase<T extends CustomBarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>>
        extends CustomChart<T> implements CustomBarLineScatterCandleBubbleDataProvider {
    ...
    protected CustomXAxisRenderer mXAxisRenderer;

    // /** the approximator object used for data filtering */
    // private Approximator mApproximator;

    public CustomBarLineChartBase(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public CustomBarLineChartBase(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//            mLegendRenderer.computeLegend(mData);
    ...
    public void calculateOffsets() {
        ...
        if (!mCustomViewPortEnabled) {
            ...
            if (mXAxis.isEnabled() && mXAxis.isDrawLabelsEnabled()) {
                ...
                } else if (mXAxis.getPosition() == CustomXAxis.CustomXAxisPosition.TOP) {

                    offsetTop += xlabelheight;

                } else if (mXAxis.getPosition() == CustomXAxis.CustomXAxisPosition.BOTH_SIDED) {
    ...
    protected float[] getMarkerPosition(Entry e, Highlight highlight) {
        ...
        if (this instanceof CustomBarChart) {
            ...
            CustomBarData bd = (CustomBarData) mData;
            float space = bd.getGroupSpace();
            int setCount = mData.getDataSetCount();
            int i = e.getXIndex();

            if (this instanceof CustomHorizontalBarChart) {
    ...
    public CustomXAxisRenderer getRendererXAxis() {
     ...
     * @param xAxisRenderer
     */
    public void setXAxisRenderer(CustomXAxisRenderer xAxisRenderer) {
